...
excerpt: "Paco Drawing Stats is a website where it parses drawing data from a professional artist
...
**Paco Drawing Stats** is a website where it parses drawing data from a professional artist
and illustrator, Paco Panda (also known as pandapaco, pacopanda, and probably a million
iterations with his name).
