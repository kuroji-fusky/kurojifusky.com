...
export function HomeHero() {
  return (
    <HomeSection id="hero" expandContent>
      <div className="h-screen flex flex-col gap-0 items-center justify-center px-1.5 py-10 mx-auto max-w-[90%] 2xl:max-w-[80%]">
        {/* Image container */}
...
function HomeHeroItem({ title, link }: HHIProps) {
  return (
    <Link href={link ?? "#"}>
      <a
        className="h-full relative rounded-[10rem] flex flex-col gap-2 m-0.5 w-full shadow-2xl hover:shadow-sona-royalblue-600
