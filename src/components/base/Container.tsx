...
export default function Container({ title, description, image, children }: IContainerProps) {
  ...
  return (
    <>
      <Head>
        ...
        <meta name="keywords" content="portfoilo, skepfusky, Kokoro Husky, projects" />
