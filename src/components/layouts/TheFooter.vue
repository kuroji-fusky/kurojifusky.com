<template>
  <footer>
    <div id="wrapper" class="flex justify-between item-center">
      <div id="social-icons" class="flex gap-x-1.75">
        ...
        <a href="#" target="_blank" rel="noopener noreferrer"><i class="fab fa-soundcloud"></i></a>
