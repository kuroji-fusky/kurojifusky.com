...
export default function Resume() {
  ...
  return (
    <Container title={t} description={d}>
      <section className="mt-[6.75rem] mb-5 max-w-screen-2xl mx-auto px-5 flex flex-col gap-y-3">
        <h1 className="text-5xl xl:text-6xl">Resume</h1>
      ...
      <div className="max-w-screen-2xl mx-auto px-5">
        <h2 className="py-5">Profiency</h2>
